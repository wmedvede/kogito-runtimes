...
public class JobCallbackResourceDef {
    ...
    public static org.kie.kogito.jobs.service.api.Job buildCallbackPatternJobNewApi(ProcessInstanceJobDescription description, String callback) {
    ...
    private static TimerSchedule buildSchedule(ProcessInstanceJobDescription description) {
        return TimerSchedule.builder()
                .startTime(description.expirationTime().get().toString())
