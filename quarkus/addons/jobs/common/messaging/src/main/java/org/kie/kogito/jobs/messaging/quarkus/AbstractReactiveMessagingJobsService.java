...
import static org.kie.kogito.jobs.api.JobCallbackResourceDef.buildCallbackPatternJobNewApi;
...
public abstract class AbstractReactiveMessagingJobsService implements JobsService {
    ...
    public String scheduleProcessInstanceJob(ProcessInstanceJobDescription description) {
        Job job = buildCallbackPatternJobNewApi(description, buildCallbackURI(description, serviceUrl.toString()));
