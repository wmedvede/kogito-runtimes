...
public class KafkaRecipient<T extends KafkaRecipientPayloadData<?>> extends Recipient<T> {
    ...
    public static class BuilderSelector {
        ...
        public KafkaRecipient.Builder<KafkaRecipientStringPayloadData> forStringPayload() {
            return new KafkaRecipient.Builder<>(new KafkaRecipient<>());
        }

        public KafkaRecipient.Builder<KafkaRecipientBinaryPayloadData> forBinaryPayload() {
            return new KafkaRecipient.Builder<>(new KafkaRecipient<>());
        }
    }
